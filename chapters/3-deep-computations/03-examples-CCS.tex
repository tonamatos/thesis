...
The basin of attraction of the 2-cycle $\{0,1\}$ is the union of magenta and cyan regions; these two colors alternate like semaphore lights: points~$z$ in the cyan region are those whose subsequence $N_{\rho}^{(2\cdot\bullet)}(z)$ of even Newton iterates (resp., $N_{\rho}^{(2\cdot\bullet+1)}(z)$ of odd iterates) has limit $1$ (resp., limit~$0$).

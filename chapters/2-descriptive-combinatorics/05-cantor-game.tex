...
The game I study in this section, Baker's game, is similar: two players take turns selecting real numbers; Player I tries to ensure that some element in the fixed set $S$ remains in between all of these real numbers.
